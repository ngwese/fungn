...
,
		"openrect" : [ 91.0, 164.0, 1346.0, 387.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 706.0, 56.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "route 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 528.0, 19.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 528.0, 67.0, 58.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 852.5, 190.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 852.5, 130.5, 53.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 852.5, 88.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "close"
				}
...
,
					"patching_rect" : [ 852.5, 161.0, 40.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 901.5, 88.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 852.5, 49.5, 46.0, 22.0 ],
					"style" : "",
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 852.5, 19.0, 56.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 494.0, 128.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 548.0, 348.0, 50.0, 22.0 ],
					"style" : "",
					"textcolor" : [ 0.741176, 0.356863, 0.047059, 1.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 618.0, 92.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "r input-range"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 692.0, 15.0, 69.0, 22.0 ],
					"saved_object_attributes" : 					{
						"allwindowsactive" : 0,
						"audiosupport" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1257.0, 136.0, 82.0, 22.0 ],
					"style" : "",
					"text" : "unpack s 0 0."
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.290196, 0.309804, 0.301961, 0.0 ],
					"checkedcolor" : [ 0.741176, 0.356863, 0.047059, 1.0 ],
					"id" : "obj-136",
					"maxclass" : "toggle",
					"numinlets" : 1,
					"numoutlets" : 1,
					...
					"presentation" : 1,
					"presentation_rect" : [ 508.0, 344.5, 24.0, 24.0 ],
					"style" : "",
					"uncheckedcolor" : [ 0.741176, 0.356863, 0.047059, 0.14 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1172.0, 169.5, 70.0, 22.0 ],
					"style" : "default",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1149.0, 343.5, 199.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1232.0, 360.5, 34.0, 22.0 ],
					"style" : "default",
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1149.0, 360.5, 35.0, 22.0 ],
					"style" : "default",
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1332.5, 192.5, 58.0, 22.0 ],
					"style" : "default",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1059.0, 206.5, 83.0, 20.0 ],
					"style" : "default",
					"text" : "store a preset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 977.0, 278.5, 83.0, 20.0 ],
					"style" : "default",
					"text" : "view windows"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1248.5, 245.5, 58.0, 22.0 ],
					"style" : "default",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1172.0, 206.5, 58.0, 22.0 ],
					"style" : "default",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1139.5, 206.5, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1139.5, 245.5, 42.0, 22.0 ],
					"style" : "default",
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1139.5, 295.5, 52.0, 22.0 ],
					"style" : "default",
					"text" : "store $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1023.0, 295.5, 90.0, 22.0 ],
					"style" : "default",
					"text" : "storagewindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 940.0, 295.5, 78.0, 22.0 ],
					"style" : "default",
					"text" : "clientwindow"
				}
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 972.0, 360.5, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 977.0, 229.5, 58.0, 22.0 ],
					"restore" : 					{
						"live.text" : [ 0.0 ],
						"preset-cv-enable" : [ 0 ]
					}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1241.5, 392.5, 1058.0, 392.5, 1058.0, 347.5, 981.5, 347.5 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1158.5, 383.5, 1058.0, 383.5, 1058.0, 347.5, 981.5, 347.5 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1258.0, 337.5, 981.5, 337.5 ],
					"source" : [ "obj-52", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 862.0, 222.0, 835.0, 222.0, 835.0, 7.0, 862.0, 7.0 ],
					"source" : [ "obj-71", 0 ]
				}
