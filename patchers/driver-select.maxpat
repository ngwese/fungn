...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 698.0, 565.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "2"
				}
...
,
					"patching_rect" : [ 682.777161, 282.895508, 75.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 631.242493, 337.291931, 29.5, 22.0 ],
					"style" : "",
					"text" : "> 0"
				}
...
,
					"patching_rect" : [ 682.777161, 598.664429, 104.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Lato",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 608.802307, 565.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 595.110901, 605.164429, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 595.110901, 498.0, 57.5, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -0.787445, -0.627668, 38.17857, 29.627668 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 659.492493, 649.161072, 60.0, 61.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.031349, 4.186166, 18.540983, 20.0 ],
					"togglemode" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 595.110901, 729.0, 92.0, 22.0 ],
					"style" : "",
					"text" : "adstatus switch"
				}
...
,
					"style" : "",
					"text" : "pattr output-device",
					"varname" : "output-device"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.0, 293.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
,
					"patching_rect" : [ 346.474854, 232.584717, 86.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Lato",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 346.474854, 201.551178, 102.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 346.474854, 164.29921, 178.939545, 21.0 ],
					"pattrmode" : 1,
					"prefix_mode" : 2,
					"presentation" : 1,
					"presentation_rect" : [ 316.324707, 4.372332, 178.626709, 21.0 ],
					"prototypename" : "Lato9",
					"style" : "arc-tan-menu",
					"varname" : "umenu[1]"
				}
...
,
					"patching_rect" : [ 122.474869, 232.584717, 86.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Lato",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 122.474869, 201.551178, 100.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 122.474869, 164.29921, 178.939545, 21.0 ],
					"pattrmode" : 1,
					"prefix_mode" : 2,
					"presentation" : 1,
					"presentation_rect" : [ 81.698013, 4.872332, 178.626709, 21.0 ],
					"prototypename" : "Lato9",
					"style" : "arc-tan-menu",
					"varname" : "umenu"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 131.974869, 266.803162, 111.782288, 266.803162, 111.782288, 151.346451, 131.974869, 151.346451 ],
					"source" : [ "obj-65", 0 ]
				}
		...
		"styles" : [ 			{
				...
				"default" : 				{
					...
					"bgfillcolor" : 					{
						...
						"color" : [ 0.191161, 0.191155, 0.191158, 1.0 ],
						"angle" : 270.0,
						"proportion" : 0.39,
						"autogradient" : 0
					}
